...
public class RegistrationController {
    ...
    @FXML
    private TableView<RegistrationTM> tblregister;
    ...
    @FXML
    private TableColumn<RegistrationTM,String> colRegFee;

    @FXML
    private TableColumn<RegistrationTM,String> colCourseId;

    @FXML
    private TableColumn<RegistrationTM,String> colOperate;

    @FXML
    private TableColumn<RegistrationTM,String> colCourseId1;
...
//
//    public TableColumn<RegistrationTM,String> colRegid;
//    public TableColumn <RegistrationTM,String>  colRegdate;
//    public TableColumn  <RegistrationTM,String> colRegFee;
//    public TableColumn <RegistrationTM,String>  colStudentid;
//    public TableColumn <RegistrationTM,String>  colCourseId;
//    public TableColumn <RegistrationTM,String>  colOperate;
//    public TableColumn <RegistrationTM,String>  colCourseId1;
    ...
    public void initialize() throws Exception {
       colRegid.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("regNo"));
       colRegdate.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("regDate"));
       colRegFee.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("regFee"));
       colStudentid.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("studentId"));
       colCourseId.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("courseId"));
       colOperate.setCellValueFactory(new PropertyValueFactory<RegistrationTM,String>("btn"));
    ...
    private void setTblregister(){
        colCourseId.setCellValueFactory(new PropertyValueFactory<>("regNo"));
        colRegdate.setCellValueFactory(new PropertyValueFactory<>("regDate"));
        colRegFee.setCellValueFactory(new PropertyValueFactory<>("regFee"));
        colCourseId1.setCellValueFactory(new PropertyValueFactory<>(""));
    }
